...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/register by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Dec 2022 10:55:06 GMT -->
<!-- <head>
...
<li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#5d35383131321d2f3c253c733e3230"><span class="__cf_email__" data-cfemail="5f373a3333301f2d3e273e713c3032">[email&#160;protected]</span></a></li>
...
<a href="register" class="btn style1">Register Now</a>
</li>
</ul>
...
<form class="form-wrap formReg" action="/admin/register" method="POST">
    @csrf
<div class="row">
<div class="col-lg-12">
<div class="form-group">
...
<div class="col-lg-12">
<div class="form-group">
<input id="" name="country" type="text" placeholder="Country..." >
</div>
@error('country')
<p class="text-danger">{{$message}}</p>
@endError
...
<div class="col-lg-12">
<div class="form-group">
<input id="" name="houseAddress" type="text" placeholder="House Address..." >
</div>
@error('houseAddress')
<p class="text-danger">{{$message}}</p>
@endError
...
<div class="col-lg-12">
<div class="form-group">
<input id="" name="fone" type="text" placeholder="Phone Number..." >
</div>
@error('fone')
<p class="text-danger">{{$message}}</p>
@endError
...
<div class="col-lg-12">
<div class="form-group">
<input id="" name="zipCode" type="text" placeholder="Zip Code..." >
</div>
@error('zipCode')
<p class="text-danger">{{$message}}</p>
@endError
...
I Agree with the <a class="link style1" href="terms-of-service.html">Terms &amp; conditions</a>
 ...
 <div class="col-lg-12">
<div class="form-group">
<button class="btn style1" type="submit" name="reg" value="submit">
Register Now
</button>
</div>
</div>
<div class="col-md-12">
<p class="mb-0">Have an Account? <a class="link style1" href="/admin/login">Sign In</a></p>
</div>
</div>
</form>
</div>
