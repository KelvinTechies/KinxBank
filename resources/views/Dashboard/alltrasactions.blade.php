                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    ...
                                    <td><img src="images/social/facebook.png" alt="" width="22" class="me-3 img-fluid">{{$trasaction->UserName}}</td>
                                       ...
                                       {{-- <p style='.($status=='Pending'?'color:red':'color:green').';><b>'.$status.'</b></p>  --}}
                                       <td class="text-danger">{{$trasaction->Status}}</td>
                                       {{-- <form action="/approve/{{ $trasaction->id }}" method="post">
                                        @csrf
                                        @METHOD('PUT') --}}
                                       <td><a href="/approve/{{ $trasaction->id }}" class="badge px-3 py-2 bg-primary">Approve</a></td>
                                    {{-- </form> --}}
                                    </tr> 
                                    <!-- <tr>
                                       <td>
