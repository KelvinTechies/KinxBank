                ...
                <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="/trasactions">See more</a>
                            </div>
                            <div class="card-body">
                                <div class="invoice-content">
                                    <ul>
                                        @if(count($depositAmount)>0)
                                        @foreach($depositAmount as $depo)
                                        <li class="d-flex justify-content-between active">
                                                <div class="d-flex align-items-center">
                                                    <div class="invoice-user-img me-3"><img src="images/avatar/1.jpg" alt=""
                                                            width="50"></div>
                                                    <div class="invoice-info">
                                                    <h5 class="mb-0">{{$depo->UserName}}</h5>
                                                        <p>{{ $depo->Date }} at {{ $depo->Time }}</p>
                                                    </div>
                                                </div>
                                                <div class="text-end">
                                                    <h5 class="mb-2">+{{ $depo->Amount }}</h5>
                                                    <span class=" text-white bg-danger">{{ $depo->Status }}</span>
                                                </div>
                                            </li> 
                                            @endForeach
                                            @else
